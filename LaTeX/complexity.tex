...
$$}
\uncover<+->{$$
\lim_{n\rightarrow\infty}\frac{4n^2}{n^2}+\lim_{n\rightarrow\infty}\frac{k_1n}{n^2}+\lim_{n\rightarrow\infty}\frac{k_2 \log n(n-1)}{n^2}+\lim_{n\rightarrow\infty}\frac{2}{n^2}=\uncover<+->{4}
$$}
\uncover<+->{$$
