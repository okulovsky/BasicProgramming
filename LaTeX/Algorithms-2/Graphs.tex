...
\begin{frame}
\uncover<+->{{\bf Лемма 2. Если в орграфе нет циклов, то в нем есть вершина с нулевой степенью захода.}}\\[0.3cm]
\uncover<+->{{\bf Лемма 4. Если в орграфе нет циклов, то в нем есть вершина с нулевой степенью исхода.}}\\[0.3cm]
\uncover<+->{{\bf Лемма 5. Если $u$ -- вершина с нулевой степенью исхода, а $v_1,\ldots,v_n$ -- топологическая сортировка $G\setminus\{u\}$, то $v_1,\ldots,v_n$ -- топологическая сортировка $G$.
}}\\[0.3cm]
\uncover<+->{{\bf Лемма 6. Если в орграфе нет циклов, то алгоритм Тарьяна найдет топологическую сортировку.}}
\end{frame}

\begin{frame}
\uncover<+->{{\bf Лемма 7. Если в орграфе есть циклы, то алгоритм Тарьяна выдаст ошибку.}}
